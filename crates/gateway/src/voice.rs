...
//! `SttService` traits using the leetium-voice crate's providers.
...
trait IntoVoiceSttProvider {
    fn into_voice_stt_provider(self) -> leetium_config::VoiceSttProvider;
}
...
impl IntoVoiceSttProvider for SttProviderId {
    fn into_voice_stt_provider(self) -> leetium_config::VoiceSttProvider {
        match self {
            SttProviderId::Whisper => leetium_config::VoiceSttProvider::Whisper,
            SttProviderId::Groq => leetium_config::VoiceSttProvider::Groq,
            SttProviderId::Deepgram => leetium_config::VoiceSttProvider::Deepgram,
            SttProviderId::Google => leetium_config::VoiceSttProvider::Google,
            SttProviderId::Mistral => leetium_config::VoiceSttProvider::Mistral,
            SttProviderId::VoxtralLocal => leetium_config::VoiceSttProvider::VoxtralLocal,
            SttProviderId::WhisperCli => leetium_config::VoiceSttProvider::WhisperCli,
            SttProviderId::SherpaOnnx => leetium_config::VoiceSttProvider::SherpaOnnx,
            SttProviderId::ElevenLabs => leetium_config::VoiceSttProvider::ElevenLabs,
        }
    }
}
...
fn resolve_openai_key(
    ...
    cfg: &leetium_config::LeetiumConfig,
...
impl LiveTtsService {
    ...
    fn load_config() -> TtsConfig {
        let cfg = leetium_config::discover_and_load();
        TtsConfig {
            enabled: cfg.voice.tts.enabled,
            provider: cfg.voice.tts.provider.clone(),
            auto: leetium_voice::TtsAutoMode::Off,
            max_text_length: 8000,
            elevenlabs: leetium_voice::ElevenLabsConfig {
            ...
            openai: leetium_voice::OpenAiTtsConfig {
            ...
            google: leetium_voice::GoogleTtsConfig {
            ...
            piper: leetium_voice::PiperTtsConfig {
            ...
            coqui: leetium_voice::CoquiTtsConfig {
...
// `SttService` trait and `NoopSttService` are defined in `leetium-service-traits`
...
impl LiveSttService {
    ...
    /// Resolve the active provider: explicit config value, or first configured.
    fn resolve_provider(
        config_provider: Option<leetium_config::VoiceSttProvider>,
...
mod tests {
    ...
    fn test_live_stt_resolve_provider_handles_explicit_and_auto_selection() {
        assert_eq!(
            LiveSttService::resolve_provider(Some(leetium_config::VoiceSttProvider::Whisper)),
