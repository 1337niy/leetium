...
use leetium_providers::{ProviderRegistry, local_gguf, local_llm, raw_model_id};
...
async fn download_unified_model(
    ...
    use leetium_providers::local_llm::models as llm_models;
...
impl LocalLlmConfig {
    ...
    pub fn save(&self) -> anyhow::Result<()> {
        let config_dir =
            leetium_config::config_dir().ok_or_else(|| anyhow::anyhow!("no config directory"))?;
