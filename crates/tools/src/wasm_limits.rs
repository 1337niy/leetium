...
impl From<&leetium_config::schema::ToolLimitOverrideConfig> for ToolLimitOverride {
    fn from(value: &leetium_config::schema::ToolLimitOverrideConfig) -> Self {
        Self {
            fuel: value.fuel,
            memory: value.memory,
        }
...
impl From<&leetium_config::schema::WasmToolLimitsConfig> for WasmToolLimits {
    fn from(value: &leetium_config::schema::WasmToolLimitsConfig) -> Self {
        let overrides = value
            .tool_overrides
            .iter()
...
mod tests {
    ...
    fn config_deser_and_conversion() {
        let config: leetium_config::schema::WasmToolLimitsConfig =
