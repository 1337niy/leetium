//! Integration tests for the leetium-graphql crate.
...
use {
    ...
    leetium_service_traits::{ServiceResult, Services},
...
impl leetium_service_traits::AgentService for MockAgent {
...
#[async_trait::async_trait]
impl leetium_service_traits::SessionService for MockSession {
    async fn list(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::ChannelService for MockChannel {
...
#[async_trait::async_trait]
impl leetium_service_traits::ConfigService for MockConfig {
...
#[async_trait::async_trait]
impl leetium_service_traits::CronService for MockCron {
    async fn list(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::ChatService for MockChat {
    async fn send(&self, p: Value) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::TtsService for MockTts {
    async fn status(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::SttService for MockStt {
    async fn status(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::SkillsService for MockSkills {
    async fn status(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::McpService for MockMcp {
    async fn list(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::BrowserService for MockBrowser {
...
#[async_trait::async_trait]
impl leetium_service_traits::UsageService for MockUsage {
    async fn status(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::ExecApprovalService for MockExecApproval {
...
#[async_trait::async_trait]
impl leetium_service_traits::OnboardingService for MockOnboarding {
...
#[async_trait::async_trait]
impl leetium_service_traits::UpdateService for MockUpdate {
    async fn run(&self, p: Value) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::ModelService for MockModel {
    async fn list(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::WebLoginService for MockWebLogin {
...
#[async_trait::async_trait]
impl leetium_service_traits::VoicewakeService for MockVoicewake {
    async fn get(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::LogsService for MockLogs {
...
#[async_trait::async_trait]
impl leetium_service_traits::ProviderSetupService for MockProviderSetup {
...
#[async_trait::async_trait]
impl leetium_service_traits::ProjectService for MockProject {
    async fn list(&self) -> ServiceResult {
...
#[async_trait::async_trait]
impl leetium_service_traits::LocalLlmService for MockLocalLlm {
...
#[async_trait::async_trait]
impl leetium_service_traits::SystemInfoService for MockSystemInfo {
...
fn build_test_schema(
    ...
    leetium_graphql::LeetiumSchema,
    broadcast::Sender<(String, Value)>,
) {
    let (tx, _) = broadcast::channel(16);
    let services = build_mock_services(&mock);
    let schema = leetium_graphql::build_schema(services, tx.clone());
    (schema, tx)
}
...
fn json_wrapper_traits_and_generic_event_conversion() {
    let parsed: leetium_graphql::scalars::Json =
    ...
    let event = leetium_graphql::types::GenericEvent::from(json!({"event": "x"}));
