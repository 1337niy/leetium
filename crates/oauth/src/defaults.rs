...
use crate::{config_dir::leetium_config_dir, types::OAuthConfig};
...
fn config_path() -> std::path::PathBuf {
    leetium_config_dir().join("oauth_providers.json")
}

/// Load the OAuth config for a provider.
///
/// Priority:
/// 1. User config file (`~/.config/leetium/oauth_providers.json`)
/// 2. Environment variables (`LEETIUM_OAUTH_{PROVIDER}_CLIENT_ID`, etc.)
/// 3. Built-in defaults
