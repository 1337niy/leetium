...
self.addEventListener("push", (event) => {
  ...
  try {
    ...
    data = { body: event.data ? event.data.text() : "New message from leetium" };
  }
  ...
  var options = {
    ...
    tag: data.sessionKey || "leetium-notification",
    data: {
      url: data.url || "/chats",
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || "leetium", options),
  );
});
