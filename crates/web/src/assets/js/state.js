...
export var pending = {};
export var models = [];
export var activeSessionKey = localStorage.getItem("leetium-session") || "main";
export var activeProjectId = localStorage.getItem("leetium-project") || "";
export var sessions = [];
export var projects = [];
...
export var chatHistory = JSON.parse(localStorage.getItem("leetium-chat-history") || "[]");
...
export var selectedModelId = localStorage.getItem("leetium-model") || "";
...
// Project filter
export var projectFilterId = localStorage.getItem("leetium-project-filter") || "";
