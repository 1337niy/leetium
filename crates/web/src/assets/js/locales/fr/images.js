...
export default {
	...
	recommendation: {
		...
		macosDockerTip:
			"Apple Container offre une isolation VM plus forte sur macOS 26+. Installez-le pour une utilisation automatique (leetium le préfère à Docker). Exécutez : brew install container",
		linuxDockerTip:
