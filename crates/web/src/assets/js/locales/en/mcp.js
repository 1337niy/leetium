...
export default {
	...
	introDetail:
		"Each tool runs as a <strong>local process</strong> on your machine (spawned via npm/uvx). Leetium connects to it over stdio and the process makes outbound API calls on your behalf using your tokens. No data is sent to third-party MCP hosts.",
