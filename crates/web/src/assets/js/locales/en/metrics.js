...
export default {
	...
	metricsDisabled: "Metrics are not enabled. Enable them in leetium.toml with [metrics] enabled = true",

	// ── Empty states ───────────────────────────────────────
	noActivityTitle: "No activity yet",
	noActivityDescription:
		"Metrics will appear here once you start using leetium. Try sending a message or running a tool to see data.",
