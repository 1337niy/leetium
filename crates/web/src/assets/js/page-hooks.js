    ...
    <div class="flex-1 flex flex-col min-w-0 p-4 gap-4 overflow-y-auto">
      ...
      <div class="max-w-[600px] bg-[var(--surface2)] border border-[var(--border)] rounded-[var(--radius)] px-5 py-4 leading-relaxed">
        <p class="text-sm text-[var(--text)] mb-2.5">
          <strong class="text-[var(--text-strong)]">Hooks</strong> run shell commands in response to lifecycle events (tool calls, messages, sessions, etc.). They live in <code class="font-mono text-xs">.leetium/hooks/</code> directories.
        </p>
      ...
      ${
        ...
        <div class="max-w-[600px] text-sm text-[var(--muted)] px-1">
          No hooks discovered. Create a <code class="font-mono text-xs">HOOK.md</code> file in <code class="font-mono text-xs">.leetium/hooks/my-hook/</code> or <code class="font-mono text-xs">~/.leetium/hooks/my-hook/</code> to get started.
        </div>
      `
					: null
			}
