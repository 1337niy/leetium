...
document.addEventListener("leetium:render-session-list", renderSessionList);
...
function showWelcomeCard() {
	...
	var botName = identity?.name || "leetium";
