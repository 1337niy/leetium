...
const OPENAI_API_KEY = process.env.LEETIUM_E2E_OPENAI_API_KEY || process.env.OPENAI_API_KEY || "";
...
test.describe("Onboarding OpenAI provider", () => {
	...
	test.skip(!OPENAI_API_KEY, "requires OPENAI_API_KEY or LEETIUM_E2E_OPENAI_API_KEY");
