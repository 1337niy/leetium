...
const ANTHROPIC_API_KEY = process.env.LEETIUM_E2E_ANTHROPIC_API_KEY || process.env.ANTHROPIC_API_KEY || "";
...
test.describe("Onboarding Anthropic provider", () => {
	...
	test.skip(!ANTHROPIC_API_KEY, "requires ANTHROPIC_API_KEY or LEETIUM_E2E_ANTHROPIC_API_KEY");
