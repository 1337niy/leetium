...
var runtimeRoot = process.env.LEETIUM_E2E_OAUTH_RUNTIME_DIR || path.join(repoRoot, "target/e2e-runtime-oauth");
var runtimeConfigDir = path.join(runtimeRoot, "config");
var runtimeHomeConfigDir = path.join(runtimeRoot, "home", ".config", "leetium");
