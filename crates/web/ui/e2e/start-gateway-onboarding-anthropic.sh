...
PORT="${LEETIUM_E2E_ONBOARDING_ANTHROPIC_PORT:-0}"
RUNTIME_ROOT="${LEETIUM_E2E_ONBOARDING_ANTHROPIC_RUNTIME_DIR:-${REPO_ROOT}/target/e2e-runtime-onboarding-anthropic}"
...
export LEETIUM_E2E_ANTHROPIC_API_KEY="${LEETIUM_E2E_ANTHROPIC_API_KEY:-${ANTHROPIC_API_KEY:-}}"
