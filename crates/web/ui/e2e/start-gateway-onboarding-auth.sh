...
# (LEETIUM_BEHIND_PROXY=true) and uses a deterministic setup code for E2E tests.

SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd -- "${SCRIPT_DIR}/../../../.." && pwd)"

PORT="${LEETIUM_E2E_ONBOARDING_AUTH_PORT:-0}"
RUNTIME_ROOT="${LEETIUM_E2E_ONBOARDING_AUTH_RUNTIME_DIR:-${REPO_ROOT}/target/e2e-runtime-onboarding-auth}"
...
export LEETIUM_BEHIND_PROXY=true
# Use a deterministic setup code for E2E tests.
export LEETIUM_E2E_SETUP_CODE=123456
