...
This document explains how streaming responses work in Leetium, from the LLM
provider through to the web UI.

## Overview

Leetium supports real-time token streaming for LLM responses, providing a much
...
The `leetium-web` crate owns the browser-facing layer: HTML templates, static
