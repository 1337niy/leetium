...
- `memory.scope` determines where the file is stored:
  - `user` (default): `~/.leetium/agent-memory/<preset>/MEMORY.md`
  - `project`: `.leetium/agent-memory/<preset>/MEMORY.md`
  - `local`: `.leetium/agent-memory-local/<preset>/MEMORY.md`
...
- `~/.leetium/agents/*.md` (user-global)
- `.leetium/agents/*.md` (project-local)
...
Example `~/.leetium/agents/reviewer.md`:
