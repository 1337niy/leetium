# Why Leetium Doesn't Support Anthropic OAuth

A common request is browser-based OAuth login for Anthropic, similar to what
Leetium offers for OpenAI Codex and GitHub Copilot.  This page explains why that
...
to use Anthropic models in Leetium is with an API key from the
...
## How to Use Anthropic in Leetium
...
3. In Leetium, go to **Settings → Providers → Anthropic** and paste the key.
...
in the future, Leetium will adopt it.  The generic infrastructure for
