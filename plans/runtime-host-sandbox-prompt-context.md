# Plan: Runtime Host + Sandbox Prompt Context (Leetium)
...
1. Add typed runtime context in `leetium-agents` prompt layer.
...
- `cargo fmt`
- `cargo test -p leetium-agents test_runtime_context_injected_when_provided`
- `cargo test -p leetium-agents test_minimal_prompt_runtime_does_not_add_exec_routing_block`
- `cargo test -p leetium-agents test_native_prompt_uses_compact_tool_list`
- `cargo clippy -p leetium-agents --tests`
- `cargo clippy -p leetium-gateway --lib`
