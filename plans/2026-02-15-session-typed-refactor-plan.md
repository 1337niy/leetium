...
Use `leetium_sessions::message::PersistedMessage` as the canonical type in `session.rs`.
...
Suggested commands:
- `cargo test -p leetium-gateway session::tests::`
- `cargo test -p leetium-sessions store::tests::`
- `cargo fmt`
