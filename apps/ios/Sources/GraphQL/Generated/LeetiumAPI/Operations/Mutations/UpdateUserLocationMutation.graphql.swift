...
extension LeetiumAPI {
  struct UpdateUserLocationMutation: GraphQLMutation {
    ...
    struct Data: LeetiumAPI.SelectionSet {
      let __data: DataDict
      init(_dataDict: DataDict) { __data = _dataDict }

      static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.MutationRoot }
      ...
      struct Agents: LeetiumAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.AgentMutation }
        static var __selections: [ApolloAPI.Selection] { [
        ...
        struct UpdateIdentity: LeetiumAPI.SelectionSet {
          let __data: DataDict
          init(_dataDict: DataDict) { __data = _dataDict }

          static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.BoolResult }
          static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .field("ok", Bool.self),
          ] }
