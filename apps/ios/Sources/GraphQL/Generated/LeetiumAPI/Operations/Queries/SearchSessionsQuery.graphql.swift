...
extension LeetiumAPI {
  struct SearchSessionsQuery: GraphQLQuery {
    ...
    struct Data: LeetiumAPI.SelectionSet {
      ...
      static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.QueryRoot }
      ...
      struct Sessions: LeetiumAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.SessionQuery }
        static var __selections: [ApolloAPI.Selection] { [
        ...
        struct Search: LeetiumAPI.SelectionSet {
          let __data: DataDict
          init(_dataDict: DataDict) { __data = _dataDict }

          static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.SessionEntry }
          static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
