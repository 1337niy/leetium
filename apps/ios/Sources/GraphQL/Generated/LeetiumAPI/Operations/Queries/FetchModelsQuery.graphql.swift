...
extension LeetiumAPI {
  struct FetchModelsQuery: GraphQLQuery {
    ...
    struct Data: LeetiumAPI.SelectionSet {
      ...
      struct Models: LeetiumAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.ModelQuery }
        static var __selections: [ApolloAPI.Selection] { [
        ...
        struct List: LeetiumAPI.SelectionSet {
          ...
          static var __parentType: any ApolloAPI.ParentType { LeetiumAPI.Objects.ModelInfo }
          static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
