...
actor LeetiumWSClient {
    ...
    private let logger = Logger(subsystem: "org.leetium.ios", category: "ws")
    ...
    private func performConnect(
        ...
        request.timeoutInterval = TimeInterval(LeetiumProtocol.handshakeTimeoutMs) / 1000.0
        ...
        let connectParams = ConnectParams(
            minProtocol: LeetiumProtocol.version,
            maxProtocol: LeetiumProtocol.version,
            client: .init(
                id: "ios",
