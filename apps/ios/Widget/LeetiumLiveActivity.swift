...
struct LeetiumLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: LeetiumActivityAttributes.self) { context in
    ...
    private func lockScreenView(
        context: ActivityViewContext<LeetiumActivityAttributes>
    ) -> some View {
        VStack(spacing: 12) {
