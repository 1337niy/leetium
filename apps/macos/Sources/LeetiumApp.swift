...
struct LeetiumApp: App {
    ...
    init() {
        ...
        LeetiumClient.installLogCallback(logStore: logStore)
        ...
        LeetiumClient.installSessionEventCallback(chatStore: chatStore)

        // Install Rust→Swift network audit bridge
        LeetiumClient.installNetworkAuditCallback(store: networkAuditStore)
