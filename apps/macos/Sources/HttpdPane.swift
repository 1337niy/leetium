    ...
    var body: some View {
        Group {
            Section {
                ...
                Text("The HTTP server runs the full Leetium gateway — web UI, REST API, and WebSocket — on your local machine. Open the address in a browser to use the web interface.")
                    .font(.callout)
