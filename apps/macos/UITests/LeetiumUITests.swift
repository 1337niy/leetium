...
final class LeetiumUITests: XCTestCase {
    ...
    func testCanAddEnvironmentVariableFromSettings() throws {
        ...
        app.launchEnvironment["LEETIUM_UI_TEST_SKIP_ONBOARDING"] = "1"
        app.launchEnvironment["LEETIUM_CONFIG_DIR"] = configDir.path
        app.launchEnvironment["LEETIUM_DATA_DIR"] = dataDir.path
        app.launch()
        ...
        let envKey = "LEETIUM_UI_TEST_\(UUID().uuidString.replacingOccurrences(of: "-", with: "_"))"
...
private extension LeetiumUITests {
    ...
    func makeRuntimeRoot() throws -> URL {
        let root = URL(fileURLWithPath: NSTemporaryDirectory(), isDirectory: true)
            .appendingPathComponent("leetium-ui-tests-\(UUID().uuidString)", isDirectory: true)
