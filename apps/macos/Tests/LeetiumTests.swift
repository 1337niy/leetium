@testable import Leetium
import XCTest

final class LeetiumTests: XCTestCase {
    private func localizedStringsDictionary(for localization: String) throws -> [String: String] {
        guard
            ...
            throw NSError(
                domain: "LeetiumTests.Localization",
                code: 1,
    ...
    func testOnboardingStatePersistsCompletion() throws {
        let suiteName = "leetium.tests.\(UUID().uuidString)"
    ...
    func testAuthPasswordChangeRejectsShortPassword() {
        ...
        XCTAssertThrowsError(
            ...
            guard case let LeetiumClientError.bridgeError(code, _) = error else {
